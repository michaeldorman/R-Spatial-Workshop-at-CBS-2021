...
Alternatively, run the following expressions to automatically download and unzip the sample data into the working directory:
...
In case you are working with an [R script file](https://github.com/michaeldorman/R-Spatial-Workshop-at-CBS-2021/raw/main/preparation.R), to properly display the Hebrew text the file needs to be opened with the UTF-8 encoding. To do that:
...
To follow the code examples in the [lecture](main.html), you should be familiar with the following topics aspects of the R language: 
